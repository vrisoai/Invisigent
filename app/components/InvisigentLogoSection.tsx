...
export function InvisigentLogoSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="invisigent-logo-section overflow-hidden bg-bg-primary py-12 md:py-16"
    ...
    >
      <div className="section-container section-inner flex w-full items-center justify-center overflow-hidden">
        <motion.div
          className="invisigent-logo-section__inner max-w-full min-w-0 overflow-hidden"
